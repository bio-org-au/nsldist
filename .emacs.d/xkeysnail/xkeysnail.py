...
define_keymap(re.compile("Firefox|Google-chrome"), {
    ...
    K("C-KEY_1"): [K("C-w")],
#    K("C-KEY_1"): [K("TAB"), K("C-w")],
#    K("C-KEY_1"): [escape_next_key, K("C-w")],
...
#    K("C-KEY_1"): [K("C-l"), sleep(0.5), K("tab"), sleep(0.5), K("C-w")],
    K("C-x"): {
        K("C-f"): K("C-t"),
        K("k"): K("C-w"),
        K("C-LEFT"): K("C-PAGE_UP"),
        K("C-RIGHT"): K("C-PAGE_DOWN"),
        K("LEFT"): K("C-PAGE_UP"),
        K("RIGHT"): K("C-PAGE_DOWN"),
        K("KEY_2"): K("C-n"),
        K("KEY_0"): K("M-F4")
    }
}, "Firefox and Chrome")
...
define_keymap(lambda wm_class: wm_class not in ("Emacs", "URxvt", "jetbrains-idea", "Gnome-terminal", "gnome-terminal-server"), {
    # Cursor
