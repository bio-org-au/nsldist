...
(defun cc/exwm-update-title ()
  (cond
   ...
   ((member exwm-title '("Messenger " "YouTube ", "Gmail "))
...
(exwm-input-set-key (kbd "<XF86AudioLowerVolume>")
                (lambda () (interactive) (shell-command "amixer set Master 5%- | sed -nr 's/.*Left.*?\\[([[:digit:]%]*)\\].*/\\1/gp'")))
(exwm-input-set-key (kbd "<XF86AudioRaiseVolume>")
                (lambda () (interactive) (shell-command "amixer set Master 5%+ | sed -nr 's/.*Left.*?\\[([[:digit:]%]*)\\].*/\\1/gp'")))
(exwm-input-set-key (kbd "<XF86AudioMute>")
                    (lambda () (interactive) (shell-command "amixer set Master 1+ toggle | sed -nr 's/.*Left.*?\\[([[:alpha:]]*)\\].*/\\1/gp'")))
